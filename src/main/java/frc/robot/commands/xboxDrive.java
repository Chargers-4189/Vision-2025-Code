...
public class xboxDrive extends Command {
  ...
  public xboxDrive(studentDriveTrain driveTrain, CommandXboxController xboxController) {
  ...
  @Override
  public void execute() {
    internaldriveTrain.arcadeDrive(internalxboxController.getLeftY(),internalxboxController.getRightY());
  }
